    ...
    const res = await fetchWithTimeout(
      "/api/generate-cookbook",
      {
        ...
        body: JSON.stringify({
          ...
          dayBeforePrep: selectedMenuDetails.dayBeforePrep,
          platingGuides: selectedMenuDetails.platingGuides,
          tableSetting: selectedMenuDetails.tableSetting,
          serviceNotes: selectedMenuDetails.serviceNotes,
          ambianceGuide: selectedMenuDetails.ambianceGuide,
          finalChecklist: selectedMenuDetails.finalChecklist,
          imagePrompts: selectedMenuDetails.imagePrompts,
        }),
      },
